  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      ...
      <header className="bg-gradient-to-r from-[#2A0845] via-[#3B185F] to-[#1E3A8A] text-white shadow-lg sticky top-0 z-30 border-b border-amber-500/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <SchoolLogo size="sm" showGlowRing={false} className="w-10 h-10" />
            <div>
              <div className="font-cinzel font-bold text-sm sm:text-base tracking-wide flex items-center space-x-2">
                <span>VIPULANANTHA COLLEGE</span>
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-400/20 text-amber-300 font-sans border border-amber-400/30">
                  SMS v4.2
                </span>
              </div>
              <div className="text-[10px] text-purple-200 font-tamil">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <button
              className="p-2 text-purple-200 hover:text-white hover:bg-white/10 rounded-full transition-colors relative"
              aria-label="Notifications"
            >
              <Bell className="w-5 h-5" />
              <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-amber-400 ring-2 ring-purple-900" />
            </button>

            <div className="h-6 w-px bg-purple-700/50" />

            <div className="flex items-center space-x-2.5">
              <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-amber-400 to-amber-200 text-purple-950 font-bold flex items-center justify-center text-xs shadow">
            ...
            <button
              id="logout-btn"
              onClick={onLogout}
              className="flex items-center space-x-1.5 text-xs bg-rose-600/80 hover:bg-rose-600 text-white px-3 py-1.5 rounded-lg font-medium transition-all shadow-sm cursor-pointer ml-2"
              title="Sign Out"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        {/* Welcome Banner */}
        <div className="rounded-2xl bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 text-white p-6 sm:p-8 relative overflow-hidden shadow-xl border border-amber-500/20">
          <div className="absolute right-0 bottom-0 translate-x-10 translate-y-10 opacity-10 pointer-events-none">
            <SchoolLogo size="intro" showGlowRing={false} />
          </div>

          <div className="relative z-10 max-w-2xl">
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-400/20 text-amber-300 border border-amber-400/30 mb-3">
              ESTD 1920 • Colombo 06
            </span>
            <h1 className="text-2xl sm:text-3xl font-extrabold font-cinzel text-white mb-2">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <span className="bg-white/10 backdrop-blur-md px-3 py-1 rounded-lg text-purple-100 flex items-center space-x-1.5">
                <Clock className="w-3.5 h-3.5 text-amber-300" />
                <span>Last session: Today at {session.lastLogin}</span>
              </span>
              <span className="bg-white/10 backdrop-blur-md px-3 py-1 rounded-lg text-purple-100 flex items-center space-x-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                <span>System Status: Optimal (Colombo Server)</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-purple-300 transition-colors">
            ...
            <div className="text-[11px] text-emerald-600 font-medium mt-1">✓ Term Target Achieved</div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-purple-300 transition-colors">
            ...
            <div className="text-2xl font-bold text-slate-900">8 Subjects</div>
            <div className="text-[11px] text-purple-800 font-medium mt-1">National Curriculum 2026</div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-purple-300 transition-colors">
            ...
            <div className="text-2xl font-bold text-slate-900">Mid-Term II</div>
            <div className="text-[11px] text-blue-600 font-medium mt-1">Commencing Aug 25</div>
          </div>

          <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 hover:border-purple-300 transition-colors">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">College House</span>
              <div className="w-8 h-8 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center">
                <GraduationCap className="w-4 h-4" />
              </div>
            </div>
            <div className="text-2xl font-bold text-amber-700">Royal Gold</div>
            <div className="text-[11px] text-slate-500 font-medium mt-1">Inter-House Lead: 1st Place</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                <h2 className="text-base font-bold text-slate-900 font-cinzel">Today's Academic Schedule</h2>
                <p className="text-xs text-slate-500">Colombo Campus • Timetable Schedule for Today</p>
              </div>
              <span className="text-xs font-semibold px-2.5 py-1 bg-purple-50 text-purple-900 rounded-md border border-purple-100">
                ...
                <div key={idx} className="py-3 flex items-center justify-between text-xs sm:text-sm">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500">{item.teacher} • Room {item.room}</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-mono text-xs text-slate-600">{item.time}</div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
            <div className="border-b border-slate-100 pb-4">
              <h2 className="text-base font-bold text-slate-900 font-cinzel">College Circulars</h2>
              <p className="text-xs text-slate-500">Official notices from Principal's Desk</p>
            </div>
